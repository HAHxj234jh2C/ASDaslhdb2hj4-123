...
PowerShell -NoProfile -ExecutionPolicy Bypass -Command "& {Checkpoint-Computer -Description "BEFORE FXDEN RestorePoint"}" >nul
...
cls
color 3
echo                                                    %S_RED%Created By %S_GREEN% FXDEN
timeout 5 >nul
cls
...
timeout 1 >nul
cls
echo [40;35m[Loaded successfully!] --^> *going to home page*
timeout 1 >nul
goto :next
...
echo                  [40;35m--^> [40;34mMade by [40;35mfxden[40;37m
...
ApplicationNotificationOnLockScreen" /t REG_DWORD /d "1" /f
REM ; Registry File By Adamx
