...
echo.                                                 RESTORE POINT!                                                                                                              
echo.              Create a restore point if you haven't already, this is to insure that nothing goes wrong with your pc.
echo.                                                                                                                    
echo.                                                                                                                    
echo.                             [1] Create A Restore    [2] Manual Restore Point (if option 1 doesn't function)
echo.                                                          
echo                                       [X] Skip (I've made a restore point)
echo.                                       
echo.                                                              
set /p input=: 
if /i %input% == 1 goto restore2
if /i %input% == 2 goto manualrestore
if /i %input% == x goto menu


:manualrestore
start https://www.youtube.com/watch?v=cOARuDta0yY
echo.
echo.  
echo.
echo                                                        Press any key to continue...     
...
:restore2
powershell -Command "& {Add-Type -AssemblyName System.Windows.Forms; [System.Windows.Forms.MessageBox]::Show('If restore point bugs, create it manually!', 'Fxden Extreme', 'OK', [System.Windows.Forms.MessageBoxIcon]::Information);}"
:: Creating Restore Point
echo Creating Restore Point
powershell -ExecutionPolicy Bypass -Command "Checkpoint-Computer -Description 'Fxden Extreme' -RestorePointType 'MODIFY_SETTINGS'" 
echo.
echo.  
echo.
echo                                                        Press any key to continue...     
...
echo.
echo.                                       [M] Nvidia GPU Tweaks            [N] Radeon GPU Tweaks *NEW!     [O] CPU Tweaks      
echo. 
echo.                                       [P] KBM Tweaks                   [Q] Cleaner                    [R] DirectX Tweaks 
echo.                                    
echo.                                       [S] Extra Tweaks                 [T] Debloat Windows            [U] Real Fortnite Ping                                                         
echo.                                                                      
echo.                                       [V] Experimental *NEW!            [W] Process Lowering           [X] Controller
echo.      
echo.                                    
echo.                                                        [1] YouTube           [2] Discord                                                   
echo.                         
echo.                                                                      
echo.
...
if /i %input% == V goto experimental
if /i %input% == W goto disableportidle
if /i %input% == X goto controller1
...
:site
start https://discord.gg/MzyP6ZGjYK
echo.
echo.  
echo.
echo                                                        Press any key to continue...     
...
:tutorial
powershell -Command "& {Add-Type -AssemblyName System.Windows.Forms; [System.Windows.Forms.MessageBox]::Show('Tutorial when full version, just read all warnings and popups and you will be good', 'Fxden Extreme Tweaks', 'OK', [System.Windows.Forms.MessageBoxIcon]::Information);}"
...
:one
start "" "https://www.youtube.com/Fxdenv1"
goto menu
...
:risxn
start https://youtube.com/fxden1x1

start https://youtube.com/Fxdenv1
cls
goto menu
...
echo.
powershell -Command "& {Add-Type -AssemblyName System.Windows.Forms; [System.Windows.Forms.MessageBox]::Show('Disable everything in Playback and recording EXCEPT YOUR HEADPHONES AND MIC', 'Fxden Extreme Tweaks', 'OK', [System.Windows.Forms.MessageBoxIcon]::Information);}"
...
:device
powershell -Command "& {Add-Type -AssemblyName System.Windows.Forms; [System.Windows.Forms.MessageBox]::Show('Click on devices, select "select all" and "remove selected"', 'Fxden Extreme Tweak', 'OK', [System.Windows.Forms.MessageBoxIcon]::Information);}"
...
echo.
echo.                                                   [3] Uninstall Apps      [4] Uninstall MS Store Apps             
echo.                                                                                                                    
echo.                                                                                                                   
echo.                                                          Type "X" to go back to menu
echo.                                                              
...
:startup
powershell -Command "& {Add-Type -AssemblyName System.Windows.Forms; [System.Windows.Forms.MessageBox]::Show('go to the LOGON section, disable all services except: antivirus, cmd.exe, and the n/a services', 'Fxden Extrem Tweaks', 'OK', [System.Windows.Forms.MessageBoxIcon]::Information);}"
...
echo.
powershell -Command "& {Add-Type -AssemblyName System.Windows.Forms; [System.Windows.Forms.MessageBox]::Show('Click on ADJUST FOR BEST PERFORMANCE, And select SHOW THUMBNAILS INSTEAD OF ICONS and SMOOTH EDGES ON SCREEN FONTS', 'Fxden Extreme Tweaks', 'OK', [System.Windows.Forms.MessageBoxIcon]::Information);}"
...
:amd
cls
powershell -Command "& {Add-Type -AssemblyName System.Windows.Forms; [System.Windows.Forms.MessageBox]::Show('ONLY DO THESE IF YOU HAVE AN AMD GPU', 'Fxden Extreme Tweaks', 'OK', [System.Windows.Forms.MessageBoxIcon]::Information);}"
...
echo.                                                                                                                  
echo.                                                                                                                  
echo.                                      [1] Tweak all Registry Settings       [2] Debloat Driver
echo.                                                                                                                  
echo.                                                                                                                  
echo.                                                          Type "X" to go back to menu                                   
echo.                                                                                                                  
...
echo.                                                                                                                  
echo.                                                                                                                  
echo.                                [1] Leave AMD User Experience Program       [2] Radeon Software Startup Processes
echo.
echo                                 [3] Disable Telemetry                       [4] Uninstall Radeon Bloatware
echo.                                                                                                                  
echo.                                                                                                                  
echo.                                                          Type "X" to go back to menu                                   
echo.                                                                                                                  
...
set /p input=: 
if /i %input% == 1 goto amdexp
if /i %input% == 2 goto amdstartup
if /i %input% == 3 goto amdtelemetry
if /i %input% == 4 goto amdbloat
if /i %input% == X cls & goto menu
...
echo Uninstalling AMD User Experience Program...
schtasks /delete /tn "\AMD User Experience Program" /f
echo Disabling AMD External Events Utility...
sc stop "AMD External Events Utility"
sc config "AMD External Events Utility" start= disabled
echo Stopping and disabling AMD user experience services...
sc stop "AMD User Experience Program Launcher"
sc config "AMD User Experience Program Launcher" start= disabled
...
echo Disabling unnecessary startup processes...
reg delete "HKCU\Software\Microsoft\Windows\CurrentVersion\Run" /v "AMDRSServ" /f
reg delete "HKCU\Software\Microsoft\Windows\CurrentVersion\Run" /v "AMDLink" /f
reg delete "HKCU\Software\Microsoft\Windows\CurrentVersion\Run" /v "AMDRadeonSoftware" /f
...
cls
echo Disabling additional AMD telemetry-related services...
sc stop "AMD User Experience Program Launcher"
sc config "AMD User Experience Program Launcher" start= disabled
...
:: echo Removing unnecessary AMD directories...
:: rmdir /s /q "C:\Program Files\AMD\CNext\CNext"
:: rmdir /s /q "C:\Program Files\AMD\PerformanceProfiler"
echo Deleting AMD scheduled tasks...
schtasks /delete /tn "\AMDLinkUpdate" /f
schtasks /delete /tn "\AMDRadeonSoftware" /f
echo Disabling AMD External Events Utility...
sc stop "AMD External Events Utility"
sc config "AMD External Events Utility" start= disabled
...
:nvidia
cls
powershell -Command "& {Add-Type -AssemblyName System.Windows.Forms; [System.Windows.Forms.MessageBox]::Show('ONLY DO THESE IF YOU HAVE AN NVIDIA GPU', 'Fxden Extreme Tweaks', 'OK', [System.Windows.Forms.MessageBoxIcon]::Information);}"
goto :nv
:nv
...
:install
powershell -Command "& {Add-Type -AssemblyName System.Windows.Forms; [System.Windows.Forms.MessageBox]::Show('Best Driver Rn - 531.41 (note: installing a new driver will give fps drops for a lil bit, it will fix if you play a couple games )', 'Fxden Extreme Tweaks', 'OK', [System.Windows.Forms.MessageBoxIcon]::Information);}"
...
:nvpi
powershell -Command "& {Add-Type -AssemblyName System.Windows.Forms; [System.Windows.Forms.MessageBox]::Show('Download Nvidia Profile Inspector and Drag the .nip file into nvidia profile inspector and click apply changes, then restart pc.', 'Fxden Extreme Tweaks', 'OK', [System.Windows.Forms.MessageBoxIcon]::Information);}"
...
echo.
powershell -Command "& {Add-Type -AssemblyName System.Windows.Forms; [System.Windows.Forms.MessageBox]::Show('Click on "optimize/defragment" to optimize your drives', 'Fxden Extreme Tweaks', 'OK', [System.Windows.Forms.MessageBoxIcon]::Information);}"
...
echo.                                                                                                                  
echo.                                                          
echo.                                              [1] Fortnite     [2] Valorant    [3] FiveM  
echo.                                                                                                                                                
echo.
echo.                                                           Press "X" to go back to menu 
echo.                                                              
...
if /i %input% == 3 goto fivem
if /i %input% == 4 goto roblox
if /i %input% == 5 goto minecraft
...
:fivem
echo.
echo [-] Setting High Priority for FiveM (GTA V)
Reg.exe add "HKEY_LOCAL_MACHINE\SOFTWARE\Policies\Microsoft\Windows\QoS\FiveM" /v "Application Name" /t REG_SZ /d "FiveM.exe" /f 
Reg.exe add "HKEY_LOCAL_MACHINE\SOFTWARE\Policies\Microsoft\Windows\QoS\FiveM" /v "DSCP value" /t REG_SZ /d "46" /f
Reg.exe add "HKEY_LOCAL_MACHINE\SOFTWARE\Policies\Microsoft\Windows\QoS\FiveM" /v "Local IP" /t REG_SZ /d "*" /f
Reg.exe add "HKEY_LOCAL_MACHINE\SOFTWARE\Policies\Microsoft\Windows\QoS\FiveM" /v "Local IP Prefix Length" /t REG_SZ /d "*" /f
Reg.exe add "HKEY_LOCAL_MACHINE\SOFTWARE\Policies\Microsoft\Windows\QoS\FiveM" /v "Local Port" /t REG_SZ /d "*" /f
Reg.exe add "HKEY_LOCAL_MACHINE\SOFTWARE\Policies\Microsoft\Windows\QoS\FiveM" /v "Protocol" /t REG_SZ /d "UDP" /f
Reg.exe add "HKEY_LOCAL_MACHINE\SOFTWARE\Policies\Microsoft\Windows\QoS\FiveM" /v "Remote IP" /t REG_SZ /d "*" /f
Reg.exe add "HKEY_LOCAL_MACHINE\SOFTWARE\Policies\Microsoft\Windows\QoS\FiveM" /v "Remote IP Prefix Length" /t REG_SZ /d "*" /f
Reg.exe add "HKEY_LOCAL_MACHINE\SOFTWARE\Policies\Microsoft\Windows\QoS\FiveM" /v "Remote Port" /t REG_SZ /d "*" /f
Reg.exe add "HKEY_LOCAL_MACHINE\SOFTWARE\Policies\Microsoft\Windows\QoS\FiveM" /v "throttle Rate" /t REG_SZ /d "_1" /f
Reg.exe add "HKEY_LOCAL_MACHINE\SOFTWARE\Policies\Microsoft\Windows\QoS\FiveM" /v "version" /t REG_SZ /d "1.0" /f
...
echo.                                                                                                                  
echo.                                                                                                                    
echo.                               [1] Power Plan     [2] Power Tweaks   [3] Power Plan Optimizations*!
echo.  
echo.                              
echo.                                               Press "X" to go back to menu                                                                                                                                                       
echo.                                                                                                                  
...
:filter 
powershell -Command "& {Add-Type -AssemblyName System.Windows.Forms; [System.Windows.Forms.MessageBox]::Show('Best settings: Ignore under - 0, Repeat Delay - 125, Repeat Rate - 25, Select: Save to registry, On and click on ok/apply', 'Fxden Extrene Panel', 'OK', [System.Windows.Forms.MessageBoxIcon]::Information);}"
...
:planopti
cls
powershell -Command "& {Add-Type -AssemblyName System.Windows.Forms; [System.Windows.Forms.MessageBox]::Show('If you get any errors, simply skip that option power plans are very different on windows 11/10', 'Fxden Extreme', 'OK', [System.Windows.Forms.MessageBoxIcon]::Information);}"
echo.
echo.
echo.
echo.              ██████╗ ██╗      █████╗ ███╗   ██╗    ████████╗██╗    ██╗███████╗ █████╗ ██╗  ██╗███████╗
...
echo.                                                                                                                                                                                                                                       
echo.                                 Tweak your power plan for the most performance possible. 
echo.                                                                                                                  
echo.                                                                                                                    
echo.                           [1] Set Max Proccessor State     [2] Set Min Proccessor State   [3] Disable USB Selective Suspend
echo.                               
echo.                           [4] Disable System Sleep         [5] Disable Hard Disk Sleep    [6] Set PCI Express Power Saving OFF
echo.                      
echo.                           [7] System Cooling Policy        [8] Disable Video Dimming      [9] RESET TO DEFAULT*
echo.  
echo.                              
echo.                                               Press "X" to go back to menu                                                                                                                                                       
echo.                                                                                                                  
...
set /p input=: 
if /i %input% == 1 goto 1max
if /i %input% == 2 goto 1min
if /i %input% == 3 goto usbsel
if /i %input% == 4 goto syssleep
if /i %input% == 5 goto disksleep
if /i %input% == 6 goto pcipower
if /i %input% == 7 goto coolingpol
if /i %input% == 8 goto dimmingvi
if /i %input% == 9 goto resetdef
if /i %input% == X cls & goto menu
...
:pcipower
echo.
powercfg -setacvalueindex SCHEME_CURRENT SUB_PCIEX POWERSAAVING 0
echo.
echo Successfully Applied all Tweaks
echo.
echo                                                        Press any key to continue...     
...
:coolingpol
echo.
powercfg -setacvalueindex SCHEME_CURRENT SUB_PROCESSOR CPUPOLICY 0
echo.
echo Successfully Applied all Tweaks
echo.
echo                                                        Press any key to continue...     
...
start https://www.youtube.com/watch?v=XWgjuUUHbO4
echo.
...
echo                    (MAKE SURE YOUR CONTROLLER IS PLUGGED DIRECTLY INTO YOUR MOTHERBOARD)
echo.                                                                                                                    
echo.                                                                                                                    
echo.                        [1] Best Controller Registry   [2] Overclock Controller
echo.                                                          
echo.       
echo.                                                        Type "X" to go back to menu
echo.                                                              
set /p input=: 
if /i %input% == 1 goto controllerreg
if /i %input% == 2 goto controller2
if /i %input% == X cls & goto menu
...
:controller2
start https://github.com/LordOfMice/hidusbf/archive/refs/heads/master.zip
start https://www.youtube.com/watch?v=8Ir4n9UNwXI
echo.
echo Successfully Applied all Tweaks
echo.
echo                                                        Press any key to continue...     
...
echo                    (TEST WITH AND WITHOUT THESE TWEAKS, THEY WILL WORK WELL FOR SOME SYSTEMS AND NOT FOR OTHERS)
echo.                                                                                                                    
echo.                                                                                                                    
echo.                                     [1] Low Latency Timing      [2] Input Delay     [3] Explorer Kill 
echo.                                                          
echo.       
echo.                                                        Type "X" to go back to menu
echo.                                                              
set /p input=: 
if /i %input% == 1 goto lowlt
if /i %input% == 2 goto inputd
if /i %input% == 3 goto explorerkill
if /i %input% == X cls & goto menu
...
:explorerkill
start https://drive.google.com/file/d/1W7LhMTGdyRodHD_aFff6XhvoU7fPSbv-/view?usp=sharing
echo.
echo Read directions on the script, make sure to never close out of the window while explorer is disabled or else you will have to restart your pc (just a normal restart not a big deal). 
echo.
echo                                                        Press any key to continue...     
pause >nul
cls
