...
set "r=[91m"  :: Red
set "g=[92m"  :: Green
set "reset=[0m"  :: Reset to default color
...
:restore2
powershell -Command "& {Add-Type -AssemblyName System.Windows.Forms; [System.Windows.Forms.MessageBox]::Show('If restore point bugs, create it manually!', 'Risxn Tweaking Panel', 'OK', [System.Windows.Forms.MessageBoxIcon]::Information);}"
:: Creating Restore Point
echo Creating Restore Point
powershell -ExecutionPolicy Bypass -Command "Checkpoint-Computer -Description 'Risxn Extreme V4.2' -RestorePointType 'MODIFY_SETTINGS'" 
echo.
echo.  
echo.
echo                                                        Press any key to continue...     
...
echo.                                                                 
echo.
echo.                                       %p%[A]%reset% Windows Settings             %p%[B]%reset% Network Tweaks             %p%[C]%reset% Power Tweaks
echo.                    
echo.                                       %p%[D]%reset% Game Priority Tweaks         %p%[E]%reset% Performance Tweaks         %p%[F]%reset% BCDedit 
echo.                                                             
echo.                                       %p%[G]%reset% Visual Tweaks                %p%[H]%reset% Storage Tweaks             %p%[I]%reset% USB Optimization   
echo. 
echo.                                       %p%[J]%reset% GameDVR                      %p%[K]%reset% CPU Tweaks                 %p%[L]%reset% Ram Tweaks   
echo.                                       
echo                                        %p%[M]%reset% KBM tweaks                   %p%[N]%reset% Delay removal!                               
echo.                                                      
echo.
echo.
echo.
...
if /i %input% == k goto cpu
if /i %input% == m goto KBMTWEAKS
if /i %input% == n goto delaydestroy
...
:tutorial
powershell -Command "& {Add-Type -AssemblyName System.Windows.Forms; [System.Windows.Forms.MessageBox]::Show('Tutorial when full version, just read all warnings and popups and you will be good', 'Fxden Pro Tweaks', 'OK', [System.Windows.Forms.MessageBoxIcon]::Information);}"
...
echo.
echo.                                                                                                                                                                                                     
echo.                    %b%Completely Optmize ALL Windows Settings.
echo.                                                                                                                                                                       
echo.                                                                                                                    
...
echo.
powershell -Command "& {Add-Type -AssemblyName System.Windows.Forms; [System.Windows.Forms.MessageBox]::Show('Disable everything in Playback and recording EXCEPT YOUR HEADPHONES AND MIC', Fxden Pro Tweaks', 'OK', [System.Windows.Forms.MessageBoxIcon]::Information);}"
...
:device
powershell -Command "& {Add-Type -AssemblyName System.Windows.Forms; [System.Windows.Forms.MessageBox]::Show('Click on devices, select "select all" and "remove selected"', 'Fxden Pro Tweaks', 'OK', [System.Windows.Forms.MessageBoxIcon]::Information);}"
...
:startup
powershell -Command "& {Add-Type -AssemblyName System.Windows.Forms; [System.Windows.Forms.MessageBox]::Show('go to the LOGON section, disable all services except: antivirus, cmd.exe, and the n/a services', 'Fxden Pro Tweaks', 'OK', [System.Windows.Forms.MessageBoxIcon]::Information);}"
...
:windebloat
powershell -Command "& {Add-Type -AssemblyName System.Windows.Forms; [System.Windows.Forms.MessageBox]::Show('This uninstalls a bunch of apps that arent needed, if you need any of them, i can send u a command in dms + i will add a revert button soon', 'S', 'OK', [System.Windows.Forms.MessageBoxIcon]::Information);}"
...
echo.                                              ╚═══╝  ╚═╝╚══════╝ ╚═════╝ ╚═╝  ╚═╝╚══════╝
echo.                                                                                                                                                                                                              
echo.                                   %r%This will remove all useless animations + more, which increases fps!   
echo.
echo.
...
echo.
powershell -Command "& {Add-Type -AssemblyName System.Windows.Forms; [System.Windows.Forms.MessageBox]::Show('Click on ADJUST FOR BEST PERFORMANCE, And select SHOW THUMBNAILS INSTEAD OF ICONS and SMOOTH EDGES ON SCREEN FONTS',  Fxden Pro Tweaks', 'OK', [System.Windows.Forms.MessageBoxIcon]::Information);}"
...
:install
powershell -Command "& {Add-Type -AssemblyName System.Windows.Forms; [System.Windows.Forms.MessageBox]::Show('Best Driver Rn - 531.41 (note: installing a new driver will give fps drops for a lil bit, it will fix if you play a couple games )', 'Fxden Pro Tweaks', 'OK', [System.Windows.Forms.MessageBoxIcon]::Information);}"
...
echo.                                  %p%Tweaking hidden registry settings will decrease latency and increase fps,                                                                                                                  
echo.                                                  
echo.                                                                
...
echo.             ╚═╝     ╚══════╝╚═╝  ╚═╝╚═╝      ╚═════╝ ╚═╝  ╚═╝╚═╝     ╚═╝╚═╝  ╚═╝╚═╝  ╚═══╝ ╚═════╝╚══════╝
echo.                                                                                              
echo.                                %b%This is a bunch of optimzations that will help with everything.
echo.                                                                   
echo.
...
echo.                                                 ╚═════╝ ╚═╝╚══════╝ ╚═════╝
echo.                                                                                                                                                         
echo.                                            %g%These Commands Fix corrupted files
echo.                                                                                                                  
echo.                                                                                                                  
...
echo.                                              ╚═╝  ╚═╝╚═╝  ╚═╝╚═╝     ╚═╝
echo.                                                                                                                                          
echo.                                 %r%Ram Tweaks help to lower ram usage and responsivness which increases fps
echo.                                                                                                                  
echo.                                                                                                                  
...
echo.                                ╚══════╝  ╚═══╝   ╚═════╝    ╚═╝  ╚═╝ ╚═════╝ ╚══════╝   ╚═╝   
echo.                                                                                                                                                              
echo.                                   %r%Click on default  if your ammount isnt on the list than type
echo.                                    
...
echo.
powershell -Command "& {Add-Type -AssemblyName System.Windows.Forms; [System.Windows.Forms.MessageBox]::Show('Click on "optimize/defragment" to optimize your drives', 'Fxden Pro Tweaks', 'OK', [System.Windows.Forms.MessageBoxIcon]::Information);}"
...
echo.                              %r%Priority Tweaks Apply Cpu, Gpu and Network Priority to games, and useful programs    
echo.                                                                                                         
echo.                                                                                                                  
...
echo.                                     ╚═╝     ╚═╝  ╚═╝╚═╝ ╚═════╝ ╚═╝  ╚═╝╚═╝   ╚═╝      ╚═╝       
echo.                                                                                                                                            
echo.                                %p%Game specific Priority Tweaks Apply Cpu, Gpu and Network Priority to specific games,  
...
echo.                                               
echo.                                                            **ETHERNET ONLY**         
echo.                                     %g%These tweaks decrease ping, and increase internet speeds,                                      
echo.                                               
echo.
...
:KBMTWEAKS
:: Set DXGKrnl Monitor Latency Tolerance
echo Setting DXGKrnl Monitor Latency Tolerance...
reg.exe add "HKLM\SYSTEM\CurrentControlSet\Services\DXGKrnl" /v "MonitorLatencyTolerance" /t REG_DWORD /d "0" /f
reg.exe add "HKLM\SYSTEM\CurrentControlSet\Services\DXGKrnl" /v "MonitorRefreshLatencyTolerance" /t REG_DWORD /d "0" /f
...
reg add "HKLM\SYSTEM\CurrentControlSet\Services\mouclass\Parameters" /v "WppRecorder_TraceGuid" /t REG_SZ /d "{fc8df8fd-d105-40a9-af75-2eec294adf8d}" /f >> APB_Log.txt
timeout /t 1 /nobreak > NUL
...
reg add "HKLM\SYSTEM\CurrentControlSet\Services\kbdclass\Parameters" /v "WppRecorder_TraceGuid" /t REG_SZ /d "{09281f1f-f66e-485a-99a2-91638f782c49}" /f >> APB_Log.txt
timeout /t 1 /nobreak > NUL
...
:aim/edit
echo.                                       [1] Recoil Reduce   [2] Bloom     [3] Shotgun
if /i %input% == 1 goto recoil
if /i %input% == 2 goto bloom
if /i %input% == 3 goto shotgun
